        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScreeningDateTime = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Version = table.Column<byte[]>(type: "BLOB", rowVersion: true, nullable: true),
                    ScreeningId1 = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bookings_Screenings_ScreeningId1",
                        column: x => x.ScreeningId1,
                        principalTable: "Screenings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Grand Cinema Hall", 10, 15 },
                    { 2, "Cozy Theater", 8, 12 },
                    { 3, "Premium Auditorium", 12, 20 },
                    { 4, "Small Screening Room", 6, 10 }
                });
